  ...
  return (
    <>
      {/* Same highlighter-mark motif already used for search-match
          ...
          advocate reaches for on a physical page, reused here rather than
          inventing a new decorative treatment. */}
      <mark aria-hidden="true" className="rounded-[3px] bg-yellow-200 px-1 text-inherit">
        {text}
